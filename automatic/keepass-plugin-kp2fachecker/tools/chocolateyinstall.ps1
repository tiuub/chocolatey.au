...
$packageName = 'keepass-plugin-kp2fachecker'
$typName = 'KP2faChecker.plgx'
$packageSearch = 'KeePass Password Safe'
$url = 'https://github.com/tiuub/KP2faChecker/releases/download/v1.1.1/KP2faChecker.plgx'
$checksum = 'ff82471636f6a23da9aa1c4178ec5eb82aec672c9a128918feff7175a294b5c9'
$checksumType = 'sha256'
